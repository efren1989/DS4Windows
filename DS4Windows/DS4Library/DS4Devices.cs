...
namespace DS4Windows
{
    ...
    public class DS4Devices
    {
        ...
        private static VidPidInfo[] knownDevices =
        {
            ...
            new VidPidInfo(0x045E, 0x028E, "Flydigi VADER4/APEX 4", InputDeviceType.DS4, VidPidFeatureSet.NoOutputData | VidPidFeatureSet.NoBatteryReading | VidPidFeatureSet.NoGyroCalib | VidPidFeatureSet.OnlyInputData0x01), // Flydigi VADER4 and APEX 4 controllers presenting as Xbox 360 controller
        };
