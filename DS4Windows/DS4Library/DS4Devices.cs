...
namespace DS4Windows
{
    ...
    public class DS4Devices
    {
        ...
        private static VidPidInfo[] knownDevices =
        {
            ...
            new VidPidInfo(0x045E, 0x028E, "Flydigi VADER4", InputDeviceType.DS4, VidPidFeatureSet.NoOutputData | VidPidFeatureSet.NoBatteryReading | VidPidFeatureSet.NoGyroCalib | VidPidFeatureSet.OnlyInputData0x01), // Flydigi VADER4 controller presenting as Xbox 360 controller
        };
